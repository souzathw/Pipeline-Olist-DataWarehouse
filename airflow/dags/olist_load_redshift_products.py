...
with DAG(
    dag_id="olist_load_redshift_products",
    ...
    def load(ingestion_date: str) -> dict:
        ...
        s3_path = f"s3://{bucket}/bronze/olist/products/ingestion_date={ingestion_date}/"
        ...
        rows = hook.get_first("select count(*) from stg.products;")[0]
