...
with DAG(
    dag_id="olist_load_redshift_customers",
    start_date=datetime(2025, 1, 1),
    schedule=None,
    catchup=False,
    tags=["olist", "redshift", "staging", "customers"],
) as dag:
    ...
    def load(ingestion_date: str) -> dict:
        ...
        s3_path = f"s3://{bucket}/bronze/olist/customers/ingestion_date={ingestion_date}/"
        ...
        rows = hook.get_first("select count(*) from stg.customers;")[0]
